...
import '../../src/Manager.css';// ✅ Uncomment if you have a CSS file
...
const ManagerView = () => {
  ...
  const handleApprove = (approvalId) => {
    ...
    setTeamExpenses((prev) =>
      prev.map((e) =>
        e.id === approvalId ? { ...e, status: "Approved" } : e
      )
    );
  ...
  const handleReject = (approvalId) => {
    ...
    setTeamExpenses((prev) =>
      prev.map((e) =>
        e.id === approvalId ? { ...e, status: "Rejected" } : e
      )
    );
      ...
      <div className="manager-header">
        ...
        <div className="summary-cards">
          ...
          <div className="summary-card">
            ...
            <p className="amount">
              {formatCurrency(teamExpenses.reduce((sum, e) => sum + e.amount, 0))}
            </p>
          </div>
        </div>
      </div>
                    ...
                    <td>
                      <div className="amount-cell">
                        <span className="converted-amount">
                          {formatCurrency(a.convertedAmount)}
                        </span>
